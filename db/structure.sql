...
--
-- Name: action_targets; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.action_targets (
    id bigint NOT NULL,
...
--
-- Name: action_targets_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

ALTER TABLE public.action_targets ALTER COLUMN id ADD GENERATED BY DEFAULT AS IDENTITY (
    SEQUENCE NAME public.action_targets_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: action_targets action_targets_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.action_targets
    ADD CONSTRAINT action_targets_pkey PRIMARY KEY (id);
...
--
-- Name: index_action_targets_on_action_id; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX index_action_targets_on_action_id ON public.action_targets USING btree (action_id);


--
-- Name: index_action_targets_on_target_character_id; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX index_action_targets_on_target_character_id ON public.action_targets USING btree (target_character_id);
...
--
-- Name: action_targets action_targets_action_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: action_targets action_targets_target_character_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
